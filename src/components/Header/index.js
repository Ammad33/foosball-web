		...
		<>
			...
			>
				<Grid className={styles.menuBarGrid}>
					<div className={styles.popupContainer} style={{ cursor: "pointer" }} onClick={() => { openSettings(); }}>
					<Avatar src = {meData.meData.imageUrl}></Avatar>
						{meData && (
							<span className={styles.name}>
								{meData.meData.fullName}
								<div className={styles.email}>{meData.meData.email}</div><p></p>
							</span>
						)}
					</div>
					<Divider className={styles.divider} />
					<div className={styles.menuBarItems}>
						<MenuItem className={styles.itemsFont} onClick={() => { openProfile(); }}> {meData.brandType} Profile</MenuItem>
						<MenuItem className={styles.itemsFont} onClick={() => { openTeam(); }}>Team</MenuItem>
						<MenuItem

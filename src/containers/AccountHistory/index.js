...
const fomoPromoInvoiceData = [
	{
		...
		activeCampaigns: '15',
		gmv: '$55,000',
		activeUserFee: '$19.95 x 8 = $159.60',
		activeCampiaignFee: '$19.95 x 8 = $159.60',
		gmvFee: '$9891',
	},
	{
		id: 2,
...
const AccountHistory = () => {
	...
	return (
		<>
			<div>
				{brandType === 'Brand' ? (<BrandAccountHistory data = {branddata} fomoPromoInvoiceData = {fomoPromoInvoiceData} />) : (<InfluencerAccountHistory data = {influencerData} fomoPromoInvoiceData = {fomoPromoInvoiceData}/>)}
			</div>
		</>
	)

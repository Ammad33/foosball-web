    ...
    <div>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.flexGrow5}>
          <div className={styles.contentContainerSectionHeader}>
            <h3>Company Address</h3>
            <Button color='primary'>Edit</Button>
          </div>
          <div className={styles.details}>
            <p>2122 10th street</p>
            <p>San Farancisco</p>
            <p>California</p>
            <p>94103</p>
            <p>USA</p>
        ...
        <div className={styles.flexGrow5}>
          ...
          <div className={styles.accountProfile}>
            <div>
              <p>
                <strong>First: </strong>Susan
              </p>
              <p>
                <strong>Last: </strong>Marsh
              </p>
              <p>
                <strong>Email: </strong>susan.marsh@gmail.com
              </p>
              <p>
              ...
              <p>
                <strong>Office: </strong>408.735.5286 <strong>Cell: </strong>
                916.825.6182
              </p>
              <p>
